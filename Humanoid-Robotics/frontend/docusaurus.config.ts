...
const config: Config = {
  ...
  organizationName: 'rabia758', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/rabia758/Q4-Hackathon/tree/main/frontend/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/rabia758/Q4-Hackathon',
          label: 'GitHub',
          position: 'right',
        },
      ],
